                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="border-stroke dark:border-form-strokedark dark:bg-form-input w-full rounded-lg border bg-transparent py-4 pl-6 pr-10 text-white outline-none focus:border-primary focus-visible:shadow-none dark:text-white dark:focus:border-primary"
                    />
